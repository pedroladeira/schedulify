...
exports.ScheduleView = void 0;
(function (ScheduleView) {
    ScheduleView["Week"] = "WEEK";
    ScheduleView["Day"] = "DAY";
})(exports.ScheduleView || (exports.ScheduleView = {}));
...
var GridBuilder = /** @class */ (function () {
    ...
    GridBuilder.build = function (columns, blocks, date, view) {
        var grid = Array(columns).fill(0).map(function (_, i) {
            var colDate = (view === exports.ScheduleView.Week ? CalendarManager.getWeekDateByWeekIndex(i, date) : date);
            var col = {
...
var ParametersManager = /** @class */ (function (_super) {
    ...
    ParametersManager.prototype.getDaysOfWeek = function () {
        return this.params.view === exports.ScheduleView.Day ? 1 : 7;
    };
