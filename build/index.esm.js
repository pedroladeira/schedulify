...
var EventsManager = /** @class */ (function () {
    ...
    EventsManager.groupCollideEvents = function (events) {
        ...
        console.log({ listOfCollides: listOfCollides });
...
var ParametersManager = /** @class */ (function () {
    function ParametersManager(params) {
        this.params = params;
    }
...
var Schedule = function (_a) {
    ...
    var _c = useState(date || new Date()), currDate = _c[0]; _c[1];
    var interEvents = useState((events === null || events === void 0 ? void 0 : events.map(function (e) {
        !e.id && (e.id = uniqueId());
        return e;
    })) || [])[0];
    ...
    return (React.createElement("div", { ref: refSchedule }));
};
